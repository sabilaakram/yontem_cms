...
export interface ApiAviationMaintenanceProductAviationMaintenanceProduct
  extends Struct.CollectionTypeSchema {
  collectionName: 'aviation_maintenance_products';
  info: {
    description: '';
    displayName: 'aviation maintenance products';
    pluralName: 'aviation-maintenance-products';
    singularName: 'aviation-maintenance-product';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    additional_benefits: Schema.Attribute.Blocks;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Features_explained: Schema.Attribute.Blocks;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    product_extra_images: Schema.Attribute.Media<
      ...
      true
    >;
    product_features: Schema.Attribute.Blocks;
    product_header_image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    product_main_image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    product_name: Schema.Attribute.String;
    product_overview: Schema.Attribute.Blocks;
    product_short_description: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiAviationProductAviationProduct
  extends Struct.CollectionTypeSchema {
...
export interface ApiPagesMetadataPagesMetadata
  ...
  info: {
    description: '';
    displayName: 'pages-metadata';
    pluralName: 'pages-metadatas';
    singularName: 'pages-metadata';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pages-metadata.pages-metadata'
    > &
      Schema.Attribute.Private;
    metadescription: Schema.Attribute.Text & Schema.Attribute.Required;
    metakeywords: Schema.Attribute.Blocks & Schema.Attribute.Required;
